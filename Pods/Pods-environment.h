...
// UPPlatformSDK
#define COCOAPODS_POD_AVAILABLE_UPPlatformSDK
#define COCOAPODS_VERSION_MAJOR_UPPlatformSDK 1
#define COCOAPODS_VERSION_MINOR_UPPlatformSDK 1
#define COCOAPODS_VERSION_PATCH_UPPlatformSDK 5
